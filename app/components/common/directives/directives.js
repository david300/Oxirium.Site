    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                ...
                var title = 'SLP | Logistic Software';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = 'SLP | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
    ...
    return {
        ...
        link: function(scope, element) {
          $( document ).ready(function(){
            var scrollTo_val = $(element).prop('scrollHeight') + 'px';
              element.slimscroll({
                  height: '100%',
                  railOpacity: 0.9,
                  start: 'bottom',
...
function routeMenuFullScroll($timeout){
    return {
        restrict: 'A',
        link: function(scope, element) {
            $timeout(function(){
...
angular
    ...
    .directive('routeMenuFullScroll',routeMenuFullScroll)
