app.controller("operationCtrl", function($scope, $rootScope, $state, operation) {

    var vm = this;
    vm.specificHeaderShow = true;
    vm.HeaderData = {
      title: operation.title,
      state: operation.state,
      description: operation.description,
      progress: operation.progress.value.toFixed(1)
    };
    ...
    vm.operaciones = operation.routes;
    ...
    vm.dynamicOrderFunction = function(criteria, direction) {
        if (direction == "ASC") {
            return criteria;
        }
        else {
    ...
    vm.orderByDirection = "ASC";
    vm.sortBy = "operationTitle";
    vm.showbody = false;

    vm.optionsSimplePieChart = {
            animate:{
                duration:0,
                enabled:false
            },
